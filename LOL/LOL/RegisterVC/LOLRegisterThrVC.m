...
@implementation LOLRegisterThrVC
-(void)viewDidLoad
{
    [super viewDidLoad];
     self.title = @"注册3/3";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UIButton *registerBtn = [UIButton buttonWithFrame:CGRectMake(15, 90, SCREEN_WIDTH-30,40) title:@"注册" backgroundImage:IMAGENAMED(@"pay_btn_orange_on")];
...
-(void)registerBtnClicked
{
    if (self.phoneTf.text.length == 0) {
      ...
      //注册接口调用
        //请求数据
        [self showHUD];
        [LOLAFNetWorkUtility  registerRequestWithParms:@{} successBlock:^(id responseObject) {
